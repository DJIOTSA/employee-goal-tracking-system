...
# from EGT.models import SignupCode, PasswordResetCode
# from EGT.models import EmailChangeCode
...
# class SignupAdminTests(APITestCase):
#     def setUp(self):
...
# @override_settings(AUTH_EMAIL_VERIFICATION=True)
# class SignupEmployeeTests(APITestCase):
#     def setUp(self):
#         # A visitor to the site
#         self.user_visitor_email = 'visitor@mail.com'
#         self.user_visitor_pw = 'visitor'
...
#         url = reverse('password-reset-verified')
#         for error_dict in error_dicts:
#             response = self.client.post(url, error_dict['payload'])
