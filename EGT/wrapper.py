...
class Account(API):
    ...
    URLS = {
        ...
        'signup_employee': '/signup/employee/',
        'signup_verify': '/signup/verify/',
        'signup_verified': "/signup/verified/",
        'signup_not_verified': "/signup/not_verified/",
        'login': '/login/',
        'logout': '/logout/',
    ...
    def signup_admin(self, **kwargs):
        path = self._get_path('signup_admin')
    ...
    def signup_employee(self, **kwargs):
        path = self._get_path('signup_employee')
